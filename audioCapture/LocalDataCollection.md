# LocalDataCollection.md

Documentation for the Local Data Collection System — a two-machine setup (Pi Zero W + Ubuntu server) used to collect and process data within reach of the WLAN. See [StandaloneDataCollection.md](StandaloneDataCollection.md) for the sealed, self-contained field unit used to collect data at other locations.
